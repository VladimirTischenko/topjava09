...
<section>
    ...
    <hr>
    <a href="saveMeal"><fmt:message key="meals.addMeal"/></a>
    <hr>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="saveMeal?id=${meal.id}"><fmt:message key="meals.update"/></a></td>
                <td><a href="deleteMeal?id=${meal.id}"><fmt:message key="meals.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
